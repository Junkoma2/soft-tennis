import {
  TUNING, COURT, G,
  SHOOT_FLAT_Z, CUT_SLICE_DEPTH, SHOT_FAMILY_ORDER,
  IDEAL_HIT_DELAY, LINE_IN_MARGIN,
} from "./config.js";

import { clamp01, lerp } from "./math.js";

import {
  state, ball, charge, matchTime, addMatchTime,
  spectatorMode, effects, setEffects, rallyControlled,
  setReceiveDone, setCpuFrontPlan, setPlayerFrontPlan, setLastHitInfo,
  keysWasd, stick, serveReady, hintText, canvas,
...
import {
  ...
  updateToss, aiStartToss,
} from "./serve.js";

import {
  setControlledX, setControlledY, startCharge, updateAimInputs,
  canPlayerHit, playerHitBall,
} from "./input.js";

import {
  updatePartner, updateRallyControlledAI, updateCpuBack, updateCpuFront,
  cpuTryReturn, partnerTryReturn,
} from "./ai.js";

// 得点・進行は試合外（main.js）が所有。試合中処理からの橋渡しで呼ぶ。
import { awardPoint } from "./main.js";

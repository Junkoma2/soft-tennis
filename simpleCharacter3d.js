...
// ラケット全体の表示倍率の初期値。実寸比で作ると画面上で細く小さく読みにくい
// ため、デフォルメとして大きめに見せる（当たり判定はリーチ定数側で別管理のため
// 影響なし）。試合中は player3d.js が「表示の調整」パネルの値で毎フレーム上書き
// するため、この初期値は model-viewer 等の単体表示でのみ使われる。
